...
pulumi.log.info(pulumi.interpolate`https://webhooks.twilio.com/v1/Accounts/${process.env.TWILIO_ACCOUNT_SID}/Proxy/${proxyService.sid}/Webhooks/Message`);
...
const voiceTaskChannelSid = getTaskChannel('voice', flexWorkspace.sid)
    .then(channel => channel.sid);


pulumi.log.info(voiceTaskChannelSid);
        ...
        env: pulumi.all([dialerAddonDomain]).apply(([ dialerAddonDomain ]) => (
            {
                ...
                REACT_APP_TASK_CHANNEL_SID: voiceTaskChannelSid
